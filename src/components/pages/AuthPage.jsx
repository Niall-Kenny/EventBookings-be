...
class AuthPage extends Component {
    ...
    LoginOrSignUp = () => {
        ...
        this.setState(({displayIsLogin}) => {return {displayIsLogin : !displayIsLogin}})
    }
    ...
    render() {
        ...
        return (
            <form onSubmit={this.handleSubmit} className="auth-form">
                ...
                <button type="button" onClick={this.LoginOrSignUp}>Switch to {displayIsLogin ? 'Sign up' : 'Login'}</button>
                </div>
            </form>
        );
    }
